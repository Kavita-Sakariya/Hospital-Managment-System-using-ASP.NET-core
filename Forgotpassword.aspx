...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <center>
        <h1 style="font-size: xx-large; font-weight: bold; color: #0000FF">Change Password</h1>
       <table style="width: 377px; height: 200px; background-color: #0000FF; font-size: large; font-weight: bold; color: #FFFFFF;" >
           ...
           <tr>
               <td colspan="2" align="center">
                   <asp:Button ID="btn_fpass" runat="server" Text="Change Password" Font-Bold="True" OnClick="btn_fpass_Click" />&nbsp&nbsp<asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Underline="True" OnClick="LinkButton1_Click" >Sign In</asp:LinkButton></td>
           </tr>
       </table>
